...
int main()
{
	...
	cout << "===== 4. Convolution ===== \n";
	//vector<vector<vector<vector<float>>>> output_1 = ConvolutionWithZeroPadding(3, stride, ZeroPaddingSize, ImageNum, FeatureCh, FeatureHeight, FeatureWidth, kernel, input_vec);
